package com.bimbonet.beerlist.data.sharedPreferences;
...
public class SharedPreferencesDataSource {
    ...
    public Boolean getIsSync() {
        return sharedPreferences.getBoolean(Constants.PREFERENCES_IS_SYNC_KEY, false);
    }

    public void setIsSync(Boolean isSync) {
        editor.putBoolean(Constants.PREFERENCES_IS_SYNC_KEY, isSync);
        editor.commit();
    }
}
